...
class Application {
    ...
    startApplication(args) {
        return __awaiter(this, void 0, void 0, function* () {
            if (args._[0] == 'iq') {
                ...
                Logger_1.shutDownLoggerAndExit(0);
            }
        });
    }
    printHeader() {
    ...
    getOssIndexRequestService(args) {
        ...
        if (args.user && args.password) {
            return new OssIndexRequestService_1.OssIndexRequestService((_a = args) === null || _a === void 0 ? void 0 : _a.user, (_b = args) === null || _b === void 0 ? void 0 : _b.password);
        }
        try {
            const config = new OssIndexServerConfig_1.OssIndexServerConfig();
            config.getConfigFromFile();
            return new OssIndexRequestService_1.OssIndexRequestService(config.getUsername(), config.getToken());
        }
        catch (e) {
            return new OssIndexRequestService_1.OssIndexRequestService();
        }
    }
