...
exports.ossIndexObject = new OssIndexServerResult_1.OssIndexServerResult({
    coordinates: 'Test',
    reference: 'reference',
    vulnerabilities: [
        {
...
exports.ossIndexObjectNoVulnerabilities = new OssIndexServerResult_1.OssIndexServerResult({
    coordinates: 'Test',
    reference: 'reference',
    vulnerabilities: [],
});
exports.applicationInternalIdResponse = {
    statusCode: 200,
    body: {
        applications: [
            {
...
exports.ossIndexServerResults = [exports.ossIndexObjectNoVulnerabilities, exports.ossIndexObject];
